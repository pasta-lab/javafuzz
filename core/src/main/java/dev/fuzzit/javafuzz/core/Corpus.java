...
public class Corpus {
    ...
    static void copy(byte[] src, int srcPos, byte[] dst, int dstPos, int length) {
        System.arraycopy(src, srcPos,  dst, dstPos, Math.min(length, src.length - srcPos));
    }

    static void copy(byte[] src, int srcPos, byte[] dst, int dstPos) {
        System.arraycopy(src, srcPos,  dst, dstPos, Math.min(src.length-srcPos, dst.length - dstPos));
    }

    static byte[] concatZeros(byte[] a, int n) {
